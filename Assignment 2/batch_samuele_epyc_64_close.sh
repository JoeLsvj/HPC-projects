...
# Parameter
current_type=EPYC
current_nodes_number=64
current_policy=close

# For each file
# The possible files are: sgemm_mkl.x dgemm_mkl.x sgemm_oblas.x dgemm_oblas.x sgemm_blis.x dgemm_blis.x sgemm_mkl_opt.x dgemm_mkl_opt.x sgemm_oblas_opt.x dgemm_oblas_opt.x sgemm_blis_opt.x dgemm_blis_opt.x
